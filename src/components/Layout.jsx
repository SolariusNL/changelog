      ...
      >
        <defs>
          <radialGradient id={`${id}-desktop`} cx="100%">
            <stop offset="0%" stopColor="rgba(140, 59, 177, 0.3)" />
            <stop offset="53.95%" stopColor="rgba(222, 96, 191, 0.09)" />
            <stop offset="100%" stopColor="rgba(96, 222, 169, 0)" />
          </radialGradient>
          <radialGradient id={`${id}-mobile`} cy="100%">
            <stop offset="0%" stopColor="rgba(180, 96, 222, 0.3)" />
            <stop offset="53.95%" stopColor="rgba(222, 96, 167, 0.09)" />
            <stop offset="100%" stopColor="rgba(96, 222, 169, 0)" />
          </radialGradient>
        </defs>
        <rect
